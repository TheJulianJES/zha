...
async def test_poll_control_checkin_response(
    ...
    assert cluster.endpoint.request.call_args_list[0].kwargs["sequence"] == 33
    assert cluster.endpoint.request.call_args_list[0].kwargs["cluster"] == 0x0020
    assert cluster.endpoint.request.call_args_list[1].kwargs["cluster"] == 0x0020
